...
<div id="dataInputContainer_wrap">
    <div class="dataInputContainer">
        ...
        <?php endif;?>
        <form id="counter_notes_submit_form" name="counter_notes_submit_form" action="" method="post"> 
            <!-- Start of notes in its client add section -->
            <?php if ($_GET['mode'] != "edit-notes"):?> 
                <div align="center">
                    <div>
                    <?php if (count($all_notes_to_this_counter_party) > 0):?>
                        ...
                        <?php foreach($all_notes_to_this_counter_party as $note):?>
                        <tr>
                            <td valign="middle" align="center"><a onclick="ask_for_delete_record('<?php echo $site_config['base_url'];?>counter-party/notes/?mode=add-notes&opt=drop&cp_id=<?php echo $cp_id;?>&note_id=<?php echo $note['note_id'];?>');" title="Drop" href="#"><img src="../../public/images/b_drop.png" border="0" alt="Drop" /></a></td>                            
                        ...
                        <table cellpadding="0" cellspacing="0" border="1" bordercolor="#e3c9e4" class="tbs-main-notes">
                            ...
                            <tr>
                                <td valign="top" class="a-left note-cats">
                                    <?php
                                        echo CommonFunctions::get_note_categories("counter_party_note_categories_required");
                                    ?>
                                </td>
                                <td valign="top"><textarea class="noteTextArea" rows="6" name="counter_note_required[note_text]"><?php if (!empty($_SESSION['counter_note_required']['note_text'])){ echo trim($_SESSION['counter_note_required']['note_text']);}?></textarea></td>
                            </tr>
                        </table>
                    </div>
                </div>
                <br /> 
                <div align="center"><input type="submit" name="counter_notes_submit" class="inputs submit" value="Save note" />&nbsp;<input onclick="location.href='<?php echo $site_config['base_url'];?>counter-party/view/'" type="button" name="counter_party_notes_exit" class="inputs submit" value="Done" /></div>
                <!-- End of Notes in its Client add section -->            
                <!-- Start of Notes in its Client edit section -->
            <?php else:?>
                <?php if (!isset($_GET['opt'])):?>        
	                <?php if (in_array(73, $_SESSION['logged_user']['permissions'])):?>                                
                <div align="center">
                    <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
                        ...
                        <tr>
                            <td valign="top" class="a-left note-cats"><?php echo CommonFunctions::get_note_categories("counter_party_note_categories_required");?></td>
                            <td align="center" valign="top"><textarea class="noteTextArea" rows="6" name="counter_note_required[note_text]"><?php if (!empty($_SESSION['counter_note_required']['note_text'])){ echo trim($_SESSION['counter_note_required']['note_text']);}?></textarea></td>
                        </tr>                                   
                    </table>
                </div>
                <br />
                ...
                <!-- If this client having notes -->
                    <?php if (count($all_notes_to_this_counter_party_in_edit) > 0):?>  
                    <br /><br />
                    <div align="center">
                        <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
                            <tr id="tr-filter">
                                <td id="td-filter" colspan="7">
                                    <div id="d-filter" class="a-left">
                                        ...
                                        <div id="d-filter-r" class="defaultFont">
                                            <?php echo CommonFunctions::get_note_categories("counter_party_note_categories_required", $inline=true, "filtering", $_POST['counter_party_note_categories_required']); ?><input name="notes_filter" type="submit" value="Filter" class="inputs submit btn-filter" />
                            ...
                            <tr>
                                ...
                                <th width="300" align="center"><?php echo ($all_notes_count_to_this_counter_party_in_edit > 1) ? "<a title=\"Sort By note\" class=\"defaultFont soringMenusLink\" href=\"?mode=notes&cp_id=".$counter_party_id."&opt=sorting&sort=note".(isset($_GET['page']) ? "&page=".$_GET['page'] : "").(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1")."\">Description ".((isset($_GET['sort']) && $_GET['sort'] == "note") ? $img : "")."</a>" : "<span class='defaultFont'>Description</span>";?></a></th>
                                <th width="100"align="center"><span class="defaultFont">Note Categories</span></th> 
                                <th width="100" align="center"><?php echo ($all_notes_count_to_this_counter_party_in_edit > 1) ? "<a title=\"Sort By note added person\" class=\"defaultFont soringMenusLink\" href=\"?mode=notes&cp_id=".$counter_party_id."&opt=sorting&sort=add_by".(isset($_GET['page']) ? "&page=".$_GET['page'] : "").(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1")."\">Added By ".((isset($_GET['sort']) && $_GET['sort'] == "add_by") ? $img : "")."</a>" : "<span class='defaultFont'>Added By</span>";?></a></th>
                                <th width="100" align="center"><?php echo ($all_notes_count_to_this_counter_party_in_edit > 1) ? "<a title=\"Sort By note added date\" class=\"defaultFont soringMenusLink\" href=\"?mode=notes&cp_id=".$counter_party_id."&opt=sorting&sort=add_date".(isset($_GET['page']) ? "&page=".$_GET['page'] : "").(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1")."\">Added Date ".((isset($_GET['sort']) && $_GET['sort'] == "add_date") ? $img : "")."</a>" : "<span class='defaultFont'>Added Date</span>";?></a></th>
                                <th width="100" align="center"><?php echo ($all_notes_count_to_this_counter_party_in_edit > 1) ? "<a title=\"Sort By note modified person\" class=\"defaultFont soringMenusLink\" href=\"?mode=notes&cp_id=".$counter_party_id."&opt=sorting&sort=mod_by".(isset($_GET['page']) ? "&page=".$_GET['page'] : "").(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1")."\">Modified By ".((isset($_GET['sort']) && $_GET['sort'] == "mod_by") ? $img : "")."</a>" : "<span class='defaultFont'>Modified By</span>";?></a></th>
                                <th width="100" align="center"><?php echo ($all_notes_count_to_this_counter_party_in_edit > 1) ? "<a title=\"Sort By note modified date\" class=\"defaultFont soringMenusLink\" href=\"?mode=notes&cp_id=".$counter_party_id."&opt=sorting&sort=mod_date".(isset($_GET['page']) ? "&page=".$_GET['page'] : "").(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1")."\">Modified Date ".((isset($_GET['sort']) && $_GET['sort'] == "mod_date") ? $img : "")."</a>" : "<span class='defaultFont'>Modified Date</span>";?></a></th>
                            </tr>
                            <?php foreach($all_notes_to_this_counter_party_in_edit as $note):?>
                            <tr>
                                <td width="50" align="center"><div class="actionTableFieldTd3">
                                               <a title="Details" href="<?php echo $site_config['base_url'];?>counter-party/notes/?mode=edit-notes&opt=view&cp_id=<?php echo $counter_party_id;?><?php echo (isset($_GET['page']) ? "&page=".$_GET['page'] : "");?>&note_id=<?php echo $note['note_id'].(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1");?>"><img src="../../public/images/b_browse.png" border="0" alt="Browse" /></a>                                   
			                                   <?php if (in_array(74, $_SESSION['logged_user']['permissions'])):?>
                                               <a title="Edit" href="<?php echo $site_config['base_url'];?>counter-party/notes/?mode=edit-notes&opt=edit&cp_id=<?php echo $counter_party_id;?><?php echo (isset($_GET['page']) ? "&page=".$_GET['page'] : "");?>&note_id=<?php echo $note['note_id'].(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1");?>"><img src="../../public/images/b_edit.png" border="0" alt="Edit" /></a>
                                               <?php endif;?>                                                                                              
			                                   <?php if (in_array(75, $_SESSION['logged_user']['permissions'])):?>                                               
                                               <a title="Drop" onclick="ask_for_delete_record('<?php echo $site_config['base_url'];?>counter-party/notes/?mode=edit-notes&opt=drop&cp_id=<?php echo $counter_party_id;?><?php echo (isset($_GET['page']) ? "&page=".$_GET['page'] : "");?>&note_id=<?php echo $note['note_id'];?>');" href="#"><img src="../../public/images/b_drop.png" border="0" alt="Drop" /></a></div></td>
                                               <?php endif;?>                                                                                              
                                ...
                                <td width="100" align="center"><span class="defaultFont"><?php echo ($note['modified_by'] != 0) ? $counterPartyModel->grab_the_username_related_note_as_modifield_person($note['modified_by']) : "--";?></span></td>
                        ...
                        <div align="center">
                            <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" class="a-left note-cats">
                                        <?php echo CommonFunctions::get_note_categories("counter_party_note_categories_required", "", "", $note_full_details['notes_categories']);?>
                                    </td>
                                    <td valign="top"><textarea class="noteTextArea defaultFont" rows="6" name="counter_note_required[note_text]"><?php if (!empty($_SESSION['counter_note_required']['note_text'])){ echo trim($_SESSION['counter_note_required']['note_text']);} else { echo $note_full_details['note'];}?></textarea></td>
                                    <td valign="middle"><span class="defaultFont"><?php echo $note_full_details['username'];?></span></td>
                                </tr>
                            </table>
                        </div>
                    <br />
                    <div align="center"><input type="submit" name="counter_notes_update_submit" class="inputs submit" value="Update" /></div>
                    <?php elseif ((isset($_GET['opt'])) && ($_GET['opt'] == "view")):?>
                        ...
                        <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
                            ...
                            <tr valign="top">
                                ...
                                <td>:</td>
                                <td width="150"><span class="defaultFont boldText"><?php echo ($note_full_details['modified_by'] != 0) ? $counterPartyModel->grab_the_username_related_note_as_modifield_person($note_full_details['modified_by']) : "--";?></span></td>                
                            </tr> 
                            <tr valign="top">
                                <td colspan="3">&nbsp;</td>
                            </tr>                        
                    ...
                    <?php elseif ((isset($_GET['opt'])) && (($_GET['opt'] == "sorting") || ($_GET['opt'] == "drop"))):?>
                        ...
                        <div align="center">
                            <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
                                ...
                                <tr>
                                    <td valign="top" class="a-left note-cats">
                                        <?php echo CommonFunctions::get_note_categories("counter_party_note_categories_required"); ?>
                                    </td>
                                    <td align="center" valign="top"><textarea class="noteTextArea" rows="6" name="case_note_required[note_text]"><?php if (!empty($_SESSION['case_note_required']['note_text'])){ echo trim($_SESSION['case_note_required']['note_text']);}?></textarea></td>
                                </tr>                                   
                            </table>
                        </div>
                        <br />
                        <div align="center"><input type="submit" name="case_notes_submit" class="inputs submit" value="Save note" />&nbsp;<input onclick="location.href='<?php echo $site_config['base_url'];?>counter-party/view/'" type="button" name="counter_party_notes_exit" class="inputs submit" value="Done" /></div>
                        	<?php endif;?>
                        <br /><br />
                        <div align="center">                
                        <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
