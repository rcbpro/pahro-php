	...
	<?php if (!strstr($_SERVER['REQUEST_URI'], "edit")):?> 
		<div align="center">
			...
			<?php if (count($all_notes_to_this_counter_party) > 0):?>
                ...
                <tr>
                    <td valign="middle" align="center"><a onclick="ask_for_delete_record('<?php echo $site_config['base_url'];?>counter-party/add/?mode=notes&opt=drop&cp_id=<?php echo $cp_id;?>&note_id=<?php echo $note['note_id'];?>');" title="Drop" href="#"><img src="../../public/images/b_drop.png" border="0" alt="Drop" /></a></td>                            
                ...
                <table border="1" bordercolor="#e3c9e4" cellpadding="0" cellspacing="0" align="center" class="tbs-main-notes">
                    ...
                    <tr>
                        <td width="50" align="center"><div class="actionTableFieldTd3">
                                       <a title="Details" href="<?php echo $site_config['base_url'];?>counter-party/edit/?mode=notes&opt=view&cp_id=<?php echo $counter_party_id;?><?php echo (isset($_GET['page']) ? "&page=".$_GET['page'] : "");?>&note_id=<?php echo $note['note_id'].(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1");?>"><img src="../../public/images/b_browse.png" border="0" alt="Browse" /></a>                                   
                                       <a title="Edit" href="<?php echo $site_config['base_url'];?>counter-party/edit/?mode=notes&opt=edit&cp_id=<?php echo $counter_party_id;?><?php echo (isset($_GET['page']) ? "&page=".$_GET['page'] : "");?>&note_id=<?php echo $note['note_id'].(isset($_GET['notes_page']) ? "&notes_page=".$_GET['notes_page'] : "&notes_page=1");?>"><img src="../../public/images/b_edit.png" border="0" alt="Edit" /></a>
                                       <a title="Drop" onclick="ask_for_delete_record('<?php echo $site_config['base_url'];?>counter-party/edit/?mode=notes&opt=drop&cp_id=<?php echo $counter_party_id;?><?php echo (isset($_GET['page']) ? "&page=".$_GET['page'] : "");?>&note_id=<?php echo $note['note_id'];?>');" href="#"><img src="../../public/images/b_drop.png" border="0" alt="Drop" /></a></div></td>
